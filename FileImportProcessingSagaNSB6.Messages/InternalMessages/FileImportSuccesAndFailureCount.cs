...
namespace FileImportProcessingSagaNSB6.Messages.InternalMessages
{
    //when you use Bus.Reply(), the message you reply on the bus cannot be of type IEvent or ICommand. It has to be IMessage
